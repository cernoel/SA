#docker run -p DST:SRC -d --rm image:tag


#docker run -d -p 5433:5433 --name postgis -e POSTGRES_PASSWORD=postgres --rm postgisandtools:simple

#exposes all open ports to host
docker run -d --network=host --name postgis -e POSTGRES_PASSWORD=postgres --rm postgisandtools:simple
